...
def _tensorflow_rbe_repos(name, compiler, python_version, os, rocm_version = None, cuda_version = None, cudnn_version = None, tensorrt_version = None, tensorrt_install_path = None, cudnn_install_path = None, compiler_prefix = None, build_bazel_src = False, sysroot = None):
    ...
    if cuda_version != None:
        ...
        exec_properties = {
            "container-image" : "docker://%s/%s@%s" % (container["registry"], container["repository"], container["digest"]),
            "Pool" : "default",
        }
...
tensorflow_rbe_repos = _tensorflow_rbe_repos
